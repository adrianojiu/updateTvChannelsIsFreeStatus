...
## Pontos de atenção
Sempre verificar qual é o workspace que esta sendo usado antes de qualquer operação. Descrição dos workspaces abaixo.
<br>

* terraform workspace list

<br>
Sempre executar operações usando arquivo de variaveis, cada arquivo esta descrito abaixo.
<br>
